...
public class SampleData {
    ...
    private static final String SAMPLE_TEXT_3 = "Lorem ipsum dolor sit amet," +
...
//        notes.add(new NoteEntity(3,getDate(-2),SAMPLE_TEXT_1));
//        notes.add(new NoteEntity(4,getDate(-3),SAMPLE_TEXT_2));
//        notes.add(new NoteEntity(5,getDate(-4),SAMPLE_TEXT_3));
        return notes;
